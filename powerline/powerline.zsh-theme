...
PROMPT="$POWERLINE_SEC1_BG$POWERLINE_SEC1_TXT  $POWERLINE_USER_NAME $VENV_STATUS%k%f$POWERLINE_SEC1_FG%K{blue}"$'\ue0b0'"%k%f%F{black}%K{blue}   "$POWERLINE_PATH" %k%f%F{blue}%K{white}"$'\ue0b0'""$POWERLINE_GIT_INFO_LEFT""$'\ue0b0'"
